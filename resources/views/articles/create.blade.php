            ...
            <form action="{{ route('article.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        >{!! old('content', 'test editor content') !!}</textarea>
                    ...
                    <div class="sm:col-span-2">
                        <label
                            class="block mb-2 text-sm font-medium text-gray-900  @error('thumbnail') dark:text-red-500 @else dark:text-white @enderror"
